...
> [!CAUTION]
> **EXPOSED SECRETS**: The `.env` file contains **real database credentials** (`npg_GN8YjQlqF9UH`) and **API keys** (Groq, Google) committed in the codebase. This is a **P0 security vulnerability**.
