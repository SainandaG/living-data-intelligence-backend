...
@router.get("/api/intelligence/deep-status/{connection_id}/{table_name}")
...
@router.get("/api/intelligence/health/{connection_id}")
...
@router.get("/api/intelligence/data-analysis/{connection_id}/{table_name}")
...
@router.get("/api/intelligence/data-quality/{connection_id}/{table_name}")
...
@router.get("/api/intelligence/business-insights/{connection_id}/{table_name}")
...
@router.get("/api/intelligence/patterns/{connection_id}/{table_name}")
...
@router.get("/api/intelligence/correlations/{connection_id}/{table_name}")
...
@router.get("/api/intelligence/anomalies/{connection_id}")
...
@router.get("/api/intelligence/predictions/{connection_id}/{table_name}")
...
@router.get("/api/intelligence/root-cause/{connection_id}/{table_name}")
...
@router.get("/api/intelligence/recommendations/{connection_id}/{table_name}")
...
@router.get("/api/intelligence/hub/{connection_id}")
...
@router.get("/api/intelligence/health/history/{connection_id}")
