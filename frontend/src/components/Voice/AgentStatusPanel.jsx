...
const AgentStatusPanel = () => {
    ...
    useEffect(() => {
        ...
        const interval = setInterval(fetchData, AGENT_POLL_INTERVAL);
    ...
    return (
        <div className={cn(
            "absolute left-full top-0 ml-4 z-[6000] transition-all duration-500",
            "w-80 animate-in fade-in slide-in-from-left-4"
        )}>
