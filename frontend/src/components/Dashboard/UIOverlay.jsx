...
import AnalystChat from '../Apps/AnalystChat';
import RecordForceGraph from './RecordForceGraph';
    ...
    return (
        <div className="header glass-card">
            ...
            <div className="btn-container">
                <button className="modern-btn btn-glass" onClick={() => openWindow('analyst', 'AI Analyst', AnalystChat)}>
                    <span>🤖</span> Analyst
                </button>
