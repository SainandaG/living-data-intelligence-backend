...
import { BarChart3, TrendingUp, Activity, Brain, Download, Zap, AlertTriangle, Network, X, FlaskConical } from 'lucide-react';
...
export default function AnalyticsView({ connectionId, graphData, mlInsights, gravitySuggestions }) {
    ...
    const handleVisualize = () => {
        ...
        const nodes = tableData.map((t, i) => {
            ...
            return {
                ...
                color: color,
                pos: [
                    // Deterministic spherical layout: distribute nodes evenly using golden angle
                    Math.sin(i * 2.399963) * Math.cos(i * 1.618034) * 250,
                    Math.sin(i * 2.399963) * Math.sin(i * 1.618034) * 250,
                    Math.cos(i * 2.399963) * 250,
                ],
                row_count: t.row_count,
                aiReason: aiReason,
                importance: importance,
                visible: true,
                x: Math.sin(i * 2.399963) * Math.cos(i * 1.618034) * 250,
                y: Math.sin(i * 2.399963) * Math.sin(i * 1.618034) * 250,
                z: Math.cos(i * 2.399963) * 250,
            };
        });
        ...
        setVizData({ nodes, edges, connection_id: connectionId });
    ...
    return (
        <div className="w-full h-full overflow-auto bg-black/40 backdrop-blur-md pointer-events-auto">
                    ...
                    <div className="flex items-center justify-between mb-4">
                        ...
                        <div className="flex gap-3">
                            ...
                            <button
                                ...
                                className="flex items-center gap-2 px-4 py-2 bg-gradient-to-r from-amber-500/20 to-orange-500/20 border border-amber-500/50 rounded-lg hover:from-amber-500/35 hover:to-orange-500/35 transition-all text-amber-300 hover:text-white shadow-[0_0_15px_rgba(251,191,36,0.15)] font-semibold"
                            >
            ...
            {/* Work on Data modal */}
            <WorkOnDataModal
                isOpen={showWorkOnData}
                onClose={() => setShowWorkOnData(false)}
                graphData={graphData}
