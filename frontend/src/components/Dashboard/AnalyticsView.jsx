...
export default function AnalyticsView({ connectionId, mlInsights, gravitySuggestions }) {
    ...
    return (
        <div className="w-full h-full overflow-auto bg-gradient-to-br from-[#0a0e1a] via-[#0f1419] to-[#0a0e1a]">
            ...
            <AnimatePresence>
                {showGraphModal && (
                    <motion.div
                        ...
                        animate={{ opacity: 1 }}
                        exit={{ opacity: 0 }}
                        className="fixed inset-0 z-[5000] bg-black/90 backdrop-blur-xl flex flex-col"
                    >
                        <div className="absolute top-6 right-6 z-[5010]">
                            <button
                            ...
                            <div className="space-y-4">
                                ...
                                <div className="pt-4 border-t border-white/10">
                                    <p className="text-sm text-[var(--text-secondary)]">
                                        <span className="font-semibold text-[var(--text-primary)]">Active Clusters:</span>{' '}
                                        {mlInsights.clusters?.join(', ') || 'None detected'}
                                    </p>
                                </div>
                            </div>
                        ) : (
