...
export default function ChatInterface({ connectionId }) {
    ...
    return (
        <>
            ...
            <motion.button
                ...
                className={`fixed bottom-8 right-8 z-50 p-4 rounded-full shadow-lg backdrop-blur-md border border-white/20 transition-all ${isOpen ? 'hidden' : 'flex'
            ...
            <AnimatePresence>
                {isOpen && (
                    <motion.div
                        ...
                        className="fixed bottom-8 right-8 z-50 w-[400px] h-[600px] bg-[#0a0e1a]/95 backdrop-blur-xl border border-white/10 rounded-2xl shadow-2xl flex flex-col overflow-hidden ring-1 ring-white/10"
                    >
                        {/* Header */}
                        <div className="p-4 border-b border-white/10 bg-gradient-to-r from-[var(--primary-cyan)]/10 to-[var(--primary-purple)]/10 flex items-center justify-between">
